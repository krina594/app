    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                <a class="logo-box" href="home.php"><span>Karma Foundation</span><i class="icon-radio_button_unchecked" id="fixed-sidebar-toggle-button"></i>
                        ...
                        <ul class="accordion-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="karma_initiative.php">Karma Initiatives</a></li>
                                    ...
                                    <!--<li><a href="donate.php">Donation Summary</a></li>-->
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                <div class="logo-sm">
                                    ...
                                    <a class="logo-box" href="index.html"><span>KARMA FOUNDATION</span></a>
                                </div>
...
?>
                                    ...
                                    <li class="dropdown">
                                        <a href="logout.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="../admin.jpg" alt="" class="img-circle"></a>
